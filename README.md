...
<h3 align="center">Site Reliability Engineer · AWS · Kubernetes · Terraform</h3>
...
- 🏗️ SRE at **ANAVSAN** — sole engineer owning infra across 2 companies
- ☁️ Executed full **GCP → AWS migration** (zero downtime, zero data loss)
- ⚙️ Built and operate a **self-managed Kubernetes cluster** (v1.32 → v1.34)
- 🔒 Architecting **SOC 2 compliance** infra with Fix Inventory + SAST pipelines
- 🔭 Exploring **AWS Bedrock**, GraphRAG, and AI-powered infrastructure
...
<p align="center">
  <i>"Reliability is not a feature — it's a discipline."</i>
</p>
